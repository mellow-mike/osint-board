...
LEGAL_SUFFIXES = (
    "Inc", "Incorporated", "LLC", "L.L.C.", "Ltd", "Limited", "LLP", "LP", "PLC", "Corp", "Corporation",
    "Co", "Company", "GmbH", "AG", "KG", "SA", "S.A.", "S.L.", "SARL", "S.A.S.", "SAS", "B.V.", "BV", "N.V.", "NV",
    "Pty", "Pvt", "OY", "AB", "AS", "ApS", "S.p.A.", "SpA", "S.r.l.", "Srl", "Sdn Bhd",
)

...
DEFAULT_WORDLIST: tuple[str, ...] = (
    ...
    "vpn", "admin", "portal", "dev", "staging", "test", "api", "cdn", "shop", "m",
    "app", "gitlab", "git", "jenkins", "jira", "confluence", "docs", "status", "grafana",
    "kibana", "db", "database", "mysql", "postgres", "redis", "internal", "intranet",
    "autodiscover", "owa", "exchange", "ftp", "sftp", "ssh", "proxy", "gateway", "dashboard",
    "beta", "demo", "support", "help", "assets", "static", "img", "images", "media", "files",
)
...
class DnsBruteforce(LookupModule):
    ...
    async def lookup(self, target: EntityRef) -> AsyncIterator[Emit]:
        ...
        for host in candidate_hosts(domain, words):
            ...
            for ip in ips:
                yield Emit(
                    EntityType.IP, ip, relation="resolves_to", parent=parent,

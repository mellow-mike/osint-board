...
MARKERS: tuple[tuple[str, str, re.Pattern[str], re.Pattern[str] | None], ...] = (
    ("WordPress", "cms", re.compile(r"/wp-content/|/wp-includes/", re.I), re.compile(r"wordpress[/ ]([0-9.]+)", re.I)),
    (
        "Drupal",
        "cms",
        re.compile(r"/sites/(?:default|all)/|drupal-settings-json|Drupal\.", re.I),
    ...
    (
        "Ghost",
        "cms",
        re.compile(r'content=["\']Ghost[^"\']*["\']|/ghost/', re.I),
    ...
    (
        "Angular",
        "framework",
        re.compile(r"ng-version=|<app-root", re.I),
    ...
    (
        "Vue.js",
        "framework",
        re.compile(r"data-v-[0-9a-f]{8}|__vue__|id=[\"']app[\"'][^>]*data-server-rendered", re.I),
        None,
    ),
    (
        "jQuery",
    ...
    (
        "Ruby on Rails",
        "framework",
        re.compile(r'name=["\']csrf-param["\'][^>]+content=["\']authenticity_token', re.I),
        None,
    ),
